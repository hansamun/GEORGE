    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="relative flex items-center justify-between px-4 sm:px-6 py-4 max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#x" className="text-black font-heading font-semibold text-lg hover:text-gray-600 transition-colors">
            X
          </a>
          <a
            href="#telegram"
      ...
      <section className="text-center py-8 sm:py-12 px-4 sm:px-6">
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-heading font-bold text-black mb-8 sm:mb-16 tracking-tight leading-tight">
          BASED GEORGE'S
        </h1>

        <div className="flex flex-col gap-6 sm:gap-8 lg:flex-row justify-center items-center max-w-5xl mx-auto mb-8 sm:mb-16">
          {/* First Image */}
          <div className="transform hover:scale-105 transition-transform duration-300 w-full max-w-[280px]">
            <Image
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 max-w-5xl mx-auto">
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-heading font-bold text-center mb-8 sm:mb-12 text-black">
          ABOUT
        </h2>
      ...
      <section className="bg-white py-12 sm:py-16 px-4 sm:px-6 text-center">
        <h2 className="text-2xl sm:text-4xl md:text-6xl font-heading font-bold text-black mb-8 sm:mb-12 tracking-tight leading-tight">
          READY TO JOIN THE MOVEMENT?
        </h2>

        <div className="flex flex-col gap-4 sm:gap-6 sm:flex-row justify-center items-center mb-8 sm:mb-12 max-w-4xl mx-auto">
          <Button className="bg-black text-white px-8 sm:px-12 py-3 sm:py-4 rounded-full text-lg sm:text-xl font-heading font-bold hover:bg-gray-800 transform hover:scale-105 transition-all duration-300 w-full sm:w-auto">
            JOIN (X)
          </Button>
          <Button className="bg-black text-white px-8 sm:px-12 py-3 sm:py-4 rounded-full text-lg sm:text-xl font-heading font-bold hover:bg-gray-800 transform hover:scale-105 transition-all duration-300 w-full sm:w-auto">
            JOIN (TELEGRAM)
        ...
        <div className="bg-gray-100 rounded-lg p-4 sm:p-6 max-w-4xl mx-auto border border-gray-200">
      ...
      {/* Footer */}
      <footer className="bg-gray-50 py-8 sm:py-12 px-4 sm:px-6">
