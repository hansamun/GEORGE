...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header */}
      <header className="relative flex items-center justify-between px-4 sm:px-6 py-4 max-w-7xl mx-auto bg-white">
      ...
      {/* CTA Section */}
      <section id="cta" className="bg-white py-12 sm:py-16 px-4 sm:px-6 text-center">
        ...
        <div className="bg-gray-100 rounded-lg p-4 sm:p-6 max-w-4xl mx-auto border border-gray-200 fade-in-up stagger-4">
      ...
      {/* Footer */}
      <footer id="contact" className="bg-gray-50 py-8 sm:py-12 px-4 sm:px-6">
